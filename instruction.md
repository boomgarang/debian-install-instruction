...
### Установка Debian 12
> Для установки использовать образ из этого репозитория, либо с [официального сайта Debian](https://cdimage.debian.org/debian-cd/current/amd64/iso-cd/debian-12.8.0-amd64-netinst.iso). Главное, чтобы версия совпадала.
